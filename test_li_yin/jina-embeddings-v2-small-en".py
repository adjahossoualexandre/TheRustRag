...
class JinaEmbeddingsV2SmallEnEMbedder(TransformerEmbedder):
...
TOKENIZER_PATH = "jinaai/jina-embeddings-v2-small-en"
...
transformer_embedder = JinaEmbeddingsV2SmallEnEMbedder(MODEL_PATH)
